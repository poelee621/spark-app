...
主题类型判断：
- 如果主题包含"区别""差异""是什么""为什么""怎么理解""科普""概念""历史""由来""比较""原理""机制""结构""演变"等关键词，属于「知识解释型」。此时干货风格应输出知识框架、对比维度、核心概念、记忆方法，绝不能输出"一周只攻一个点""找真实样本"等行动步骤。
- 如果主题是技能/目标/行动类（如减肥、做小红书、学编程），属于「行动技能型」，此时干货风格才输出具体执行步骤。
硬性要求：
1. 每个段落、每条痛点、每条干货都必须紧扣主题「${topic}」，要包含具体场景、真实矛盾、可执行动作或知识细节。
2. 严禁使用任何空泛鸡汤口号，例如但不限于："你比自己以为的更有力量"、"你不需要很厉害才能开始"、"把目标拆小"、"别和别人比，只和昨天的自己比"、"每完成一个小动作都是给未来的自己铺路"。
3. 痛点要写出真实困境（带场景或后果），不要写人人都懂的废话。
4. 干货要给出围绕主题的具体内容：知识型给框架/维度/概念，行动型给步骤/动作/反馈方法，不能是"坚持""努力""相信自己"这类抽象词。
